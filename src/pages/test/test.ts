...
ionViewWillLoad() {//钩子函数，将要进入页面的时候触发
    ...
    //var api = 'http://test.api.gyhsh.cn/api/goods/group_list?pageSize=10&pageIndex=1&curCityCode=4403'
     var api = 'http://test.api.gyhsh.cn/api/goods/list?pageSize=10&pageIndex=1&keyWord=111&shop_Id=1&curCityCode=4403';
     //var api='http://test.api.gyhsh.cn/api/goods/index_list?goods_Type=1&curCityCode=4403';
